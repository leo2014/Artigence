...
<body>
                ...
                <div class="modal-dialog">
                        <div class="modal-content">
                                <div class="modal-header">
                                    ...
                                    <h4 class="modal-title" id="modalLabel">添加ARTI</h4>
                                </div>
                                        ...
                                        <div class="form-group control-group">
                                            ...
                                            <div class="col-sm-9 controls">
                                                <input type="text" class="form-control" id="inputMac" placeholder="mac地址" 
                                                    ...
                                                    minlength="6"
                                                    required
                                                    data-validation-ajax-ajax="user/arti/macAjaxValid.json"
                                                    data-validation-maxlength-message="mac字符在6到12之间"
                                                    data-validation-minlength-message="mac字符在6到12之间"
                                                    data-validation-ajax-message="该arti mac已存在"
                                                    name="mac" />
                                        ...
                                        <div class="form-group control-group">
                                            ...
                                            <div class="col-sm-9 controls">
                                                <input type="text" class="form-control" id="inputSerialNum" placeholder="序列号" 
                                                    ...
                                                    minlength="6"
                                                    required
                                                    data-validation-ajax-ajax="user/arti/serialAjaxValid.json"
                                                    data-validation-maxlength-message="序列号字符在6到12之间"
                                                    data-validation-minlength-message="序列号字符在6到12之间"
                                                    data-validation-ajax-message="该mac序列号已存在"
                                                    name="serialNum" />
                                                <p class="help-block"></p>
                                            </div>
                                        </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $("#artiinfo-li > a").addClass('active');$("#artiinfo-li").parent("ul.submenu").addClass('active');  
            //datatable
             $.extend(settings,{
                    dom: '<"clear">lfrtip',
                   "columns":[
